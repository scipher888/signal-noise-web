...
<footer class="site-foot">
  <p>Signal &amp; Noise is written under the pen name Synthia Cipher. Each edition is a human essay and a labeled AI essay, then audits in The World Behind the Words. The human author owns the wording, published claims, and errors of the human essay.</p>
...
<p><a href="archive/">Full archive →</a></p>
    ...
    open(os.path.join(OUT, "index.html"), "w", encoding="utf-8").write(
        render("Signal & Noise", "Essays about AI, judgment, and human consequences — a human essay and a labeled AI essay on the same subject, then published audits.", "", home_main, "/").replace("<title>Signal &amp; Noise — Signal &amp; Noise</title>", "<title>Signal &amp; Noise</title>"))
...
<p>I use AI to draft and pressure-test — surfacing counterarguments and exposing weak reasoning. For the human essay, editorial judgment, final wording, and published claims are mine. If the human essay is wrong, the fault is mine, not the algorithm's. The AI essay is labeled as such; it is not silently my wording.</p>
...
<p><strong>The AI's essay</strong> is a labeled machine companion on the same subject, written separately. It is not a correction, and it is not a second edition.</p>
...
<rss version="2.0">
  <channel>
    ...
    <link>{BASE_URL}/</link>
    <description>Essays about AI, judgment, and human consequences — a human essay and a labeled AI essay on the same subject, then published audits.</description>
